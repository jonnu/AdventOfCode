...
public class Puzzle18 implements Puzzle {
    ...
    public void solve() {
        try (BufferedReader reader = resourceReader.read("y2023/puzzle18.txt")) {
            ...
            System.out.printf("Polygon Area      : %.0f%n", polygon.area());
            System.out.printf("Polygon Perimeter : %.0f%n", polygon.perimeter());
            ...
            // you closer, but there are actually four "corners" still unaccounted for, hence
            // the +1.
            // @TODO count corners probably. using adj.
            System.out.printf("Polygon Total     : %.0f%n", polygon.area() + polygon.perimeter() / 2 + 1);
            System.out.println();
        }
    }
